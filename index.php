...
spl_autoload_register(function ($class) { include 'model/' . $class . '.php'; });
spl_autoload_register(function ($class) { include 'parser/' . $class . '.php'; });
...
$scraper = ScraperFactory::createScraper($feed);
$scraper->scrape();
